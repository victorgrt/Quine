...
int main(void)
{
	...
	char *s8="%ss3,n,n,t,n,t,n);%c";
	char *s9="%ss4,'1',q,s1,q,n,'2',q,s2,q,n);%ss4,'3',q,s3,q,n,'4',q,s4,q,n);%c";
	char *sa="%ss4,'5',q,s5,q,n,'p',q,sp,q,n);%ss4,'6',q,s6,q,n,'7',q,s7,q,n);%c";
	char *sb="%ssb,'8',q,s8,q,n,'9',q,s9,q,n);%ss4,'a',q,sa,q,n,'b',q,sb,q,n);%c";
	char *sc="%ss5,b,b,b,b,'t',q,n);%c%ss6,sp,n,n,n);%c%ss7,sp,sp,n,n);%c%ss9,sp,sp,n,n);%c%ssa,sp,sp,sp,n,n);%c%ssb,sp,sp,sp,n,n);%c%ssc,sp,' ',sp,' ',sp,n,sp,' ',sp,' ',sp,' ',sp,' ');%c	return (0);%c}%c";//ici manque le reste pour finaliser
	...
	printf(s5,b,b,b,b,'t',q,n);	printf(s6,sp,n,n,n);	printf(s7,sp,sp,n);
	printf(s9,sp,sp,n,n);	printf(sa,sp,sp,n,n);
	printf(sb,sp,sp,n,n);	printf(sc,sp,' ',sp,' ',sp,n,sp,' ',sp,n,sp,' ',sp,n,n);
	return (0);
}